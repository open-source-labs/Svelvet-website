...
<p class="text-gray-600">
  <code class="bg-rose-100 rounded-lg p-1">Svelvet</code> allows you to download
  ...
  <code class="bg-rose-100 rounded-lg p-1">shareable</code>
  to your Svelvet application. To access this feature, click the
  <code class="bg-rose-100 rounded-lg p-1">download</code>
  button in the bottom left of the diagram. This will download a JSON file that
  can be shared with any developer using
  <code class="bg-rose-100 rounded-lg p-1">Svelvet</code>! After receiving the
  JSON file, simply open it and copy paste the JSON string into the
  <code class="bg-rose-100 rounded-lg p-1">upload</code>
  box in the bottom left of the diagram. Now just click the
  <code class="bg-rose-100 rounded-lg p-1">upload</code> button and you should be
...
<div>
  ...
  <p class="text-gray-600">
    ...
    below and then click the <code class="bg-rose-100 rounded-lg p-1"
      >download</code
    >
    button in the bottom right. Once the download has been completed,
    <code class="bg-rose-100 rounded-lg p-1">refresh</code>
    the page to reset the diagram. Then copy the downloaded JSON string into the
    <code class="bg-rose-100 rounded-lg p-1">upload</code>
    box and click the <code class="bg-rose-100 rounded-lg p-1">button</code> to see
